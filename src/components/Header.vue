...
defineEmits(['decrementar-carrito','incrementar-carrito','agregar-carrito', 'eliminar-producto', 'vaciar-carrito'])
                                        ...
                                        >
                                            ...
                                            <td class="flex align-items-start gap-4">
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @click="$emit('decrementar-carrito', producto.id)"
                                                >
                                                    -
                                                </button>
                                                    {{ producto.cantidad }}
                                                <button
                                                    type="button"
                                                    class="btn btn-dark"
                                                    @click="$emit('incrementar-carrito', producto.id)"
                                                >
                                                    +
                                                </button>
                                            </td>
